...
{
    /// <summary>
    /// Source - http://depblog.weblogs.us/2018/12/09/xamarin-forms-keep-visual-element-in-view-linked-to-content-scroll-view/
    /// </summary>
    public partial class PageEasyScrollHeader : ContentPage
    {
        double _titleTextTop;

        public PageEasyScrollHeader()
        {
            InitializeComponent();
        ...
        private void OnTitleTextSizeChanged(object sender, EventArgs e)
        {
            TitleText.SizeChanged -= OnTitleTextSizeChanged;
        ...
        private void OnBearImageSizeChanged(object sender, EventArgs e)
        {
            BearImage.SizeChanged -= OnBearImageSizeChanged;
