    ...
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        public int ScheduleNotification(string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(AndroidApp.Context, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(AndroidApp.Context.Resources, Resource.Drawable.exo_notification_small_icon))
                .SetSmallIcon(Resource.Drawable.exo_notification_small_icon)
        ...
        {
            var args = new ModelNotificationEventArgs
            {
                Title = title,
                Message = message,
            };
